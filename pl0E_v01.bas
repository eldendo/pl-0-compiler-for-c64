1 goto 4000
10 ************************************
20 * pl/0E compiler for c64 v0.1      *
...
6235 gosub 9800: rem debug id table
...
6530 if sy$<>"[" then 6620:rem no array
6540 gosub 5800: rem getsym
6550 if sy$="num" then is=num:goto 6600:rem literal
6560 if sy$="id" then in$=name$:gosub 9500:rem get identifier
6570 if ic$<>"const" then er$="literal or const expected":goto 5450:rem error
6580 is=iv: rem set array size to value of constant
6600 gosub 5800: rem getsym
6610 ex$="]":gosub 5400: rem expect
...
7225 tl=lv-il:tv=iv: rem temporary storage avoiding ...
7226 rem ... problems with varcall in expression 
...
8275 if ic$="const" then cf$="lit":cl=0:ca=iv:gosub 5300:rem gen
8277 if ic$="var" then cf$="lod":cl=lv-il:ca=iv:gosub 5300:rem gen
...
9080 cf$="opr":cl=0:ca=op:gosub 5300:rem gen
